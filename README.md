...
- [Для любимых партнеров RndTechConf 2023](Partners/README.md)
    ...
    - [(В РАБОТЕ) Расписание застройки и участия](Partners/Schedule/README.md)
    - [(В РАБОТЕ) Расположение стендов на площадке](Partners/Map/README.md)
    - [Правила поведения](Partners/CodeOfConduct/README.md)
    - [(В РАБОТЕ) Регистрация участников](Partners/Registration/README.md)